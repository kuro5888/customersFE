        ...
        class _ {
          ...
          static read(x, k = !1) {
            ...
            for (let H of b) {
              let Q = H(x);
              if (Q !== null) {
                let ne = Object.assign(Object.assign({}, Q), {
                  startOfLine: k,
                });
        ...
        t.exports = m(function $(G, ue, se, we) {
          ...
          if (Kn(G)) {
            for (
              ...
              xt +=
                ' ' + tn[mr].name + '=' + be(pe(tn[mr].value), 'double', le);
            return (
              (xt += '>'),
            ...
            return (
              ...
              o(_) && o(T)
                ...
                : Object.keys(T).reduce(function (D, R) {
                    var M = T[R];
                    return (
                      n.call(D, R) ? (D[R] = E(D[R], M, O)) : (D[R] = M), D
                    );
                  }, I)
            );
          }, 'merge'),
...
`,
      ...
      vm = L((e) => {
        ...
        function u(E) {
          ...
          return (
            T.unshift('[' + _.join('') + ']'), new RegExp(T.join('|'), 'g')
          );
        }
...
`,
    ...
    function o3(e, t) {
      ...
      var r = jv(t);
      return Nv(
        Jr({}, r, { lightness: Aa(0, 1, r.lightness - parseFloat(e)) }),
      );
    }
    var a3 = Sa(o3),
      bt = a3;
