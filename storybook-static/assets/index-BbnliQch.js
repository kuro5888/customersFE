import { c as tn } from './_commonjsHelpers-Cpj98o6Y.js';
var Ue = { exports: {} };
(function (r, t) {
  (function (n, a) {
    a(t);
    ...
    function b(e) {
      var o, c;
      return (c = (o = _.exec(e)) === null || o === void 0 ? void 0 : o[0]) !==
        null && c !== void 0
        ? c
        : null;
    }
    ...
    function C(e) {
      ...
      if (e.type === 'JsdocTypeVariadic') {
        if (
          ((o = e.element) === null || o === void 0 ? void 0 : o.type) ===
          'JsdocTypeName'
        )
          return e;
        throw new l(e);
    ...
    function Nr({ allowTrailingComma: e }) {
      return I({
        ...
        parseInfix: (o, c) => {
          ...
          if (
            d.length > 0 &&
            d.slice(0, -1).some((h) => h.type === 'JsdocTypeVariadic')
          )
    ...
    function Q({ allowedAdditionalTokens: e }) {
      return I({
        name: 'nameParslet',
        accept: (o) =>
          o === 'Identifier' || o === 'this' || o === 'new' || e.includes(o),
        parsePrefix: (o) => {
      ...
      return I({
        ...
        parsePrefix: (c) => {
          ...
          if (c.consume('StringValue'))
            ...
            let q = '';
            const K = ['Identifier', '@', '/'];
            for (; K.some((G) => c.consume(G)); )
              (q += w.text), (w = c.lexer.current);
            h = {
              type: 'JsdocTypeSpecialNamePath',
              value: q,
              specialType: d,
        ...
        parsePrefix: (c) => {
          ...
          if (!c.consume('}')) {
            ...
            for (;;) {
              ...
              c.acceptLexerState(w),
                N === void 0 && o && (N = c.parseIntermediateType(g.OBJECT));
              let F = !1;
              if (
      ...
      return I({
        ...
        parseInfix: (h, w) => {
          ...
          if (
            ...
            return (
              h.acceptLexerState(K),
              { type: 'JsdocTypeJsdocObjectField', left: J(w), right: G }
            );
          }
        },
      });
        ...
        parsePrefix: (e) => {
          ...
          return (
            e.consume('is'),
            {
              ...
              left: o,
              right: J(e.parseIntermediateType(g.INFIX)),
            }
          );
        },
      });
    ...
    const Fr = I({
        ...
        parsePrefix: (e) => (
          e.consume('keyof'),
          { type: 'JsdocTypeKeyof', element: J(e.parseType(g.KEY_OF_TYPE_OF)) }
        ),
      }),
      Lr = I({
        name: 'importParslet',
      ...
      Ur = I({
        ...
        parsePrefix: (e) => (
          e.consume('readonly'),
          {
            ...
            element: e.parseType(g.KEY_VALUE),
          }
        ),
      }),
      Vr = I({
          ...
          if (e.consume(':')) {
            ...
            d.acceptLexerState(e),
              (c = {
                ...
                key: o,
                right: d.parseType(g.ARRAY_BRACKETS),
              }),
              e.acceptLexerState(d);
          } else
            throw new Error(
    ...
    function ut() {
      return {
        JsdocTypeParenthesis: (e, o) =>
          `(${e.element !== void 0 ? o(e.element) : ''})`,
        ...
        JsdocTypeVariadic: (e, o) =>
          e.meta.position === void 0
            ? '...'
            : ge(e.meta.position, o(e.element), '...'),
        ...
        JsdocTypeGeneric: (e, o) => {
          if (e.meta.brackets === 'square') {
            ...
            return `${o(e.left)}${e.meta.dot ? '.' : ''}<${e.elements.map(o).join(', ')}>`;
        },
        ...
        JsdocTypeSpecialNamePath: (e) =>
          `${e.specialType}:${X(e.value, e.meta.quote)}`,
        ...
        JsdocTypeSymbol: (e, o) =>
          `${e.value}(${e.element !== void 0 ? o(e.element) : ''})`,
    ...
    const zr = {
      ...
      JsdocTypeSpecialNamePath: (e) =>
        Z(e.specialType + ':' + X(e.value, e.meta.quote)),
      JsdocTypeName: (e) =>
        e.value !== 'function'
          ? Z(e.value)
...
var Ve = Ue.exports,
    ...
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let s of an(t))
        !sn.call(r, s) &&
          ...
          De(r, s, {
            get: () => t[s],
            enumerable: !(a = nn(t, s)) || a.enumerable,
          });
    return r;
  },
  ln = (r, t, n) => (
    (n = r != null ? rn(on(r)) : {}),
    cn(De(n, 'default', { value: r, enumerable: !0 }), r)
  ),
  mt = m((r, t) => {
    var n =
        ...
        (_ || f.call(v, S)) &&
          !(
            ...
            (S == 'length' ||
              (x && (S == 'offset' || S == 'parent')) ||
              (U &&
                (S == 'buffer' || S == 'byteLength' || S == 'byteOffset')) ||
              l(S, j))
          ) &&
          A.push(S);
      return A;
  ...
  ea = m((r, t) => {
    ...
    function l(p, u) {
      ...
      if (f instanceof n) {
        var T = f.__data__;
        if (!a || T.length < i - 1)
          return T.push([p, u]), (this.size = ++f.size), this;
  ...
  aa = m((r, t) => {
    function n(a, s) {
      for (var i = -1, l = a == null ? 0 : a.length; ++i < l; )
        if (s(a[i], i, a)) return !0;
      return !1;
    }
  ...
  wa = m((r, t) => {
    ...
    function U(R, A, j, S, L, J) {
      ...
      if (P && !$)
        return (
          J || (J = new n()),
          V || f(R) ? a(R, A, j, S, L, J) : s(R, A, O, j, S, L, J)
        );
      if (!(j & T)) {
  ...
  Sa = m((r, t) => {
    function n(a, s) {
      for (var i = -1, l = a == null ? 0 : a.length, p = Array(l); ++i < l; )
        p[i] = s(a[i], i, a);
      return p;
    }
      ...
      case 'union':
        return (s = r.elements) != null && s.every(qa)
          ? {
              ...a,
              name: 'enum',
              value: (i = r.elements) == null ? void 0 : i.map(Ba),
            }
          : {
              ...a,
              name: t,
              value: (l = r.elements) == null ? void 0 : l.map(ye),
            };
      case 'intersection':
        return {
          ...a,
          name: t,
          value: (p = r.elements) == null ? void 0 : p.map(ye),
        };
      default:
        ...
        return (
          (s = r.elements) != null && s.every((f) => f.name === 'literal')
            ? (u = {
                ...
                name: 'enum',
                value:
                  (i = r.elements) == null ? void 0 : i.map((f) => kt(f.value)),
              })
            : (u = {
                ...a,
                name: t,
                value: (l = r.elements) == null ? void 0 : l.map(de),
              }),
          u
        );
      case 'intersection':
        return {
          ...a,
          name: t,
          value: (p = r.elements) == null ? void 0 : p.map(de),
        };
      default:
        return { ...a, name: 'other', value: t };
    }
...
function $t({ fence: r = '```' } = {}) {
  ...
  return y(function (a) {
    let s = [[]],
      i = !1;
    for (let l of a)
      ro.test(l.tokens.description) && !i
        ? s.push([l])
        : s[s.length - 1].push(l),
...
function Kt({ startLine: r = 0, markers: t = ee } = {}) {
  ...
  return y(function (s) {
    ...
    if (
      ...
      let u = i.trimRight();
      (l.end = i.slice(u.length - t.end.length)),
        (i = u.slice(0, -t.end.length));
    }
    if (
      ((l.description = i), n.push({ number: a, source: s, tokens: l }), a++, p)
    ) {
      let u = n.slice();
      return (n = null), u;
    }
...
function Mt({ tokenizers: r }) {
  return y(function (t) {
    ...
    for (let s of r)
      if (
        ((a = s(a)),
        !((n = a.problems[a.problems.length - 1]) === null || n === void 0) &&
          n.critical)
      )
        break;
    return a;
...
function Gt() {
  ...
  return (t) => {
    ...
    if (l[0] === '[' && l[l.length - 1] === ']') {
      ...
      if (
        ((l = T[0].trim()),
        T[1] !== void 0 && (u = T.slice(1).join('=').trim()),
        l === '')
      )
        return (
          t.problems.push({
      ...
      if (a.tag === 'ignore') {
        ...
        switch (a.tag) {
          ...
          case 'argument': {
            let s = ar(a);
            s != null &&
              (n.params == null && (n.params = []), n.params.push(s));
            break;
          }
          case 'deprecated': {
            let s = or(a);
